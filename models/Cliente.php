    ...
    public function PostNew()
    {
        ...
        if($this->metodo_pago !== null){
            ...
            $consulta = $objAccesoDatos->prepararConsulta(
                "INSERT INTO clientes (nombre, apellido, tipo_doc, nro_documento, email, tipo_cliente, pais, ciudad, telefono, metodo_pago) 
                VALUES (:nombre, :apellido, :tipo_doc, :nro_documento, :email, :tipo_cliente, :pais, :ciudad, :telefono, :metodo_pago)"
            );
            ...
            // Prepara la consulta
            $consulta = $objAccesoDatos->prepararConsulta(
                "INSERT INTO clientes (nombre, apellido, tipo_doc, nro_documento, email, tipo_cliente, pais, ciudad, telefono) 
                VALUES (:nombre, :apellido, :tipo_doc, :nro_documento, :email, :tipo_cliente, :pais, :ciudad, :telefono)"
            );
        ...
        try{
            ...
            if ($e->getCode() == 23000){
                ...
                if (strpos($mensajeError, 'nro_documento') !== false) {
                    ...
                    return json_encode(array('error' => "El metodo de pago {$this->metodo_pago} no existe"));
                }
